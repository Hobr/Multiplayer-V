...
{
	m_handle = GRAPHICS::REQUEST_SCALEFORM_MOVIE((char*)id);
}
...
void Scaleform::StartFunction(const char* name)
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(m_handle, (char*)name);
}
...
void Scaleform::PushParam(int v)
{
	...
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_INT(v);
}
...
void Scaleform::PushParam(float v)
{
	...
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_FLOAT(v);
}
...
void Scaleform::PushParam(bool v)
{
	...
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_BOOL(v);
}
...
void Scaleform::PushParam(const char* v)
{
	...
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING((char*)v);
}
...
void Scaleform::PushParam(const std::string &v)
{
	...
	GRAPHICS::_ADD_SCALEFORM_MOVIE_METHOD_PARAMETER_STRING((char*)v.c_str());
}
...
void Scaleform::CallFunction(const char* name)
{
	...
	GRAPHICS::CALL_SCALEFORM_MOVIE_METHOD(m_handle, (char*)name);
}
